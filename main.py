...
class CleanerApp(App):
    def build(self):
        ...
        layout.add_widget(Label(text='🧹 TELEFON TEMİZLEYİCİ', font_size='24sp', size_hint_y=None, height=50))
        
        self.info_label = Label(text='Taramak için butona basın', font_size='16sp', size_hint_y=None, height=40)
                    ...
                    for file in files:
                        if any(file.endswith(ext) for ext in extensions):
                            ...
                            try:
                                ...
                                total_size += size
                                lbl = Label(text=f'{file[:25]}... ({size//1024}KB)', size_hint_y=None, height=30, font_size='12sp')
